...
void Cat::renderCatParticles(SDL_Renderer* renderer) {
    for (auto body = particles.begin(); body != particles.end(); body = next(body)) {
        ...
        int pixelRadius = static_cast<int>(circle->m_radius * PHYSICS_SCALE / sqrt(X_LEVEL_WINDOW_SCALE * Y_LEVEL_WINDOW_SCALE));
        int centerX = static_cast<int>(position.x * PHYSICS_SCALE / X_LEVEL_WINDOW_SCALE);
        int centerY = static_cast<int>(position.y * PHYSICS_SCALE / Y_LEVEL_WINDOW_SCALE);
...
void Cat::renderCatEyes(SDL_Renderer* renderer) {
    ...
    int xA = static_cast<int>(posA.x * PHYSICS_SCALE / X_LEVEL_WINDOW_SCALE);
    int yA = static_cast<int>(posA.y * PHYSICS_SCALE / Y_LEVEL_WINDOW_SCALE);
    ...
    int xAOpposite = static_cast<int>(posAOpposite.x * PHYSICS_SCALE / X_LEVEL_WINDOW_SCALE);
    int yAOpposite = static_cast<int>(posAOpposite.y * PHYSICS_SCALE / Y_LEVEL_WINDOW_SCALE);
